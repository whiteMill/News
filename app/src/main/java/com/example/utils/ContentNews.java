...
public class ContentNews {
    ...
    public static ArrayList<NewsEntity> getNewsEntity(){
        ...
        for(int i =0 ; i < 10 ; i++){
            ...
            if(i%2 == 1){
                ...
                String url3 = "http://img1.gtimg.com/digi/pics/hv1/54/164/1569/102066099.jpg";
                news.setPicOne(url1);
                news.setPicTwo(url2);
                news.setPicThr(url3);
            ...
            if(i == 4){
                ...
                news.setLocal("推广");
                news.setLarge(true);
                String url = "http://d.hiphotos.baidu.com/baike/c0%3Dbaike116%2C5%2C5%2C116%2C38/sign=3a644e2cce11728b24208470a995a8ab/aa18972bd40735fa0da98f049d510fb30f240836.jpg";
